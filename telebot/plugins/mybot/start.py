...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("Crashed?", "t.me/movieszzzone")]
        ])
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com")),
                          (Button.url("Deploy", url="https://t.me.movieszzzone"))],
                         [Button.url("Supp
                                     url="https://t.me/movieszzzone")]
                     ])
